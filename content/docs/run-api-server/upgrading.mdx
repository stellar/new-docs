...
If you aren't coming from an existing deployment of Horizon, feel free to skip this section and move on to [Configuring](./configuring.mdx) Horizon!
...
To enable captive mode you will need to initialize some configuration variables:
  ...
  * (required) If you run Captive Core ...
    ...
    2. ... using the experimental Captive Core server:
