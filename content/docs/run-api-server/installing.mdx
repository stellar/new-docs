...
To install Horizon, you have a few choices. You can...
  ...
  - download a [prebuilt release](https://github.com/stellar/go/releases/latest) for your target architecture and operation system, or
...
```bash
sudo apt update && sudo apt install stellar-horizon stellar-captive-core
```
...
Next, jump to [Testing Your Installation](#completing-and-testing-your-installation), or try [installing](#installing-remote-captive-core) a remote Captive Core instance.
...
If you are interested in this approach, you'll need some additional binaries on that machine. Refer to the [Remote Captive Core](./remote-core.mdx) page for details.
