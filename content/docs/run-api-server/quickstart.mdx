...
For detailed information about running Horizon and Stellar Core safely in production see the [Run and API Server](./index.mdx) and [Run a Core Node](../run-core-node/index.mdx) guides.
