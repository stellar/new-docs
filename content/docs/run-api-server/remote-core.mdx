...
git checkout tags/horizon-v2.3.0
...
**Note**: You should replace the `git switch` command above to the [latest release](https://github.com/stellar/go/releases/latest) of Horizon; it's v2.3.0 as of this writing.)
