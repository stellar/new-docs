...
However, **if you installed via [the package manager](./installing.mdx#package-manager),** the provided `stellar-horizon-cmd` wrapper will actually import a configuration from `/etc/default/stellar-horizon` and set up the environment accordingly.
