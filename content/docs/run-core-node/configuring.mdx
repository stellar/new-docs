...
`NETWORK_PASSPHRASE="Test SDF Network ; September 2015"` or `NETWORK_PASSPHRASE="Public Global Stellar Network ; September 2015"`.  For more about the Network Passphrase and how it works, check out the [glossary entry](link).
