...
Stellar Core exposes vital information about the status of your node and the network that you can use to monitor and maintain a healthy setup.  It's suitable for both human consumption and programmatic access.  This section will detail the commands and outputs, and walk you through what everything
