...
The Stellar Development Foundation maintains reference implementations of some [Stellar Ecosystem Proposals](link) to jumpstart the process of building infrastructure on top of Stellar in a way that maximizes interoperabilit among ecosystem participants. 

* [Polaris](https://github.com/stellar/django-polaris) is an extendable django app that makes it easy for anchors to [enable deposits and withdrawals](link).  Using Polaris, you can run a web server supporting any combination of SEP-1, 6, 10, 12, and 24.
