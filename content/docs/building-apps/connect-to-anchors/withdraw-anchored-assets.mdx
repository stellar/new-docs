...
At this point, you should have a [basic wallet](link) that can handle [custom assets](link), and you should have [enabled deposits](link) and used the SDF-maintained testnet [Anchor Reference Implementation](link) to get some test tokens into your wallet.  After you’ve had some fun with your new asset, it's time to learn to perform this process in reverse, and that's what we'll do here: set your wallet up to handle withdrawals.
