...
Accepting other (non-native/lumen) assets into your custodial account is achieved similarly to how it's done for native assets. In fact, all of the code above is asset-agnostic. There are a few prerequisities, however:
