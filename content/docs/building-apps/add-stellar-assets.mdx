...
*Note*: the user cannot send a given token to your pooled account unless your pooled account has opted in to that token by opening a trustline to its issuing account.</p>
