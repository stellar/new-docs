...
In this tutorial, the goal is to get to a place where a user can create, store, and access their Stellar account using an intuitive pincode encryption method.  It assumes that you have already completed the [Project Setupsection](./project-setup.mdx).
