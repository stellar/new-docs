...
We've even built a [Deployed Demo Client](https://sep24.stellar.org/), which is an interface that allows you to run those tests without needing to set up a new hosting infrastructure for that project.
