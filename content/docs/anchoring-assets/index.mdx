...
Specifically, this section covers how _anchors_ can provide services for:
...
In this section, we'll focus on the two proposals that define standards for the services listed in the first section, [SEP-24](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0024.md) and [SEP-31](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0031.md), respectively.