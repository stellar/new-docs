...
MoneyGram requires businesses to go through an onboarding process in order to get access to their testing and production environments. To get started with this process, fill out the [MoneyGram Screening Questionaire] and reach out to partnerships@stellar.org.
...
[moneygram screening questionaire]: https://stellarquestionnaire.typeform.com/to/RD1a71wQ
