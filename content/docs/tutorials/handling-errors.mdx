...
Here are some of the common errors encountered when performing a `POST /transactions`:
  ...
  - [400 errors, e.g. `tx_bad_seq`](#invalid-sequences)
  - [Fee / surge pricing errors, e.g. `tx_insufficient_fee`](#surge-pricing)
