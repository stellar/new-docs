...
Once the passive offer is created, you can manage it like any other offer using the [manage sell
offer](#manage-sell-offer) operation.
...
[multi-sig](../glossary/multisig.mdx).
...
|Home domain| string| Sets the home domain of an account. See [Federation](../federation/multisig.mdx).|
