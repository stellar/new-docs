...
- [Creating test accounts](../start/create-account.mdx) (with funding thanks to Friendbot).
...
- Load and stress testing.
  - If you want to test for performance, a good place to start is [Stellar Core's core performance document](https://github.com/stellar/stellar-core/blob/master/performance-eval.md#networks-to-test-against).
...
A script can automate this entire process by [creating an account with Friendbot](../start/create-account.mdx), and submitting a set of transactions that are predefined as a part of your testing infrastructure.
