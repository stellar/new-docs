...
Like regular transactions, fee-bump transactions goes through a series of checks in their lifecycle to determine validity.
...
- **Fee Account Signature** - The fee-bump transaction envelope must contain a valid signaure for the fee account.

- **Fee Account Balance** - The fee account must have a sufficient XLM balance to cover the fee.

- **Inner Transaction Validity** - 
