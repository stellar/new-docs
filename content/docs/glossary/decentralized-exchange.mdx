...
Offer](../start/list-of-operations.md#manage-buy-offer) or [Manage Sell
Offer](../start/list-of-operations.md#manage-sell-offer) operation. In order to make an offer, the account
