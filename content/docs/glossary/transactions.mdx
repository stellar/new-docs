...
| txNOT_SUPPORTED | -12 | The transaction type is not supported |
| txFEE_BUMP_INNER_FAILED | -13 | The fee bump inner transaction failed.  See [Fee Bumps](./fee-bumps.mdx) for more info.|
