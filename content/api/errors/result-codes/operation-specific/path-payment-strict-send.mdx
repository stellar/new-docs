...
Learn more about the [`Path Payment Strict Send` operation](../../../../docs/glossary/operations/path-payment-strict-send.mdx).
...
- OpUnderDestMin
  ...
  - The destination minimum could not be satisfied.
