...
try {
  Page<PathResponse> page = server
    .strictSendPaths()
    .sourceAsset(Asset.createNonNativeAsset("BRL", "GDVKY2GU2DRXWTBEYJJWSFXIGBZV6AZNBVVSUHEPZI54LIS6BA7DVVSP"))
    .destinationAmount("400")
    .destinationAccount("GAYOLLLUIZE4DZMBB2ZBKGBUBZLIOYU6XFLW37GBP2VZD3ABNXCW4BVA")
    .execute();

  for (PathResponse response : page.getRecords()) {
