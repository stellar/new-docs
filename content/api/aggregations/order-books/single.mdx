...
server.orderbook(new StellarSdk.Asset.native(), new StellarSdk.Asset('BB1', 'GD5J6HLF5666X4AZLTFTXLY46J5SW7EXRKBLEYPJP33S33MXZGV6CWFN'))
  .call()
  .then(function(resp) {
    console.log(resp);
  })
...
var es = server.orderbook(new StellarSdk.Asset.native(), new StellarSdk.Asset('BB1', 'GD5J6HLF5666X4AZLTFTXLY46J5SW7EXRKBLEYPJP33S33MXZGV6CWFN'))
  .cursor('now')
  .stream({
