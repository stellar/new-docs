...
try:
    print(server.offers().for_selling(Asset("USD", "GDUKMGUGDZQK6YHYA5Z6AY2G4XDSZPSZ3SW5UN3ARVMO6QSRDWP5YLEX")).call())
...
for tx in server.offers().for_selling(Asset("USD", "GDUKMGUGDZQK6YHYA5Z6AY2G4XDSZPSZ3SW5UN3ARVMO6QSRDWP5YLEX").cursor("now").stream():
  callback(tx)
```
