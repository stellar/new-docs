...
- sequence_ledger
  - number
  - The ledger number corresponding to the last time the account's sequence number changed.
- sequence_time
  - string, encoding a 64-bit UNIX timestamp
  - The timestamp corresponding to the last time the account's sequence number changed.
- subentry_count
  - number
