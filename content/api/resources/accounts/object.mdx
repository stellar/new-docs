...
- sequence_ledger
  - number
  - The unsigned 32-bit ledger number corresponding to the last time the account's sequence number was touched.
- sequence_time
  - string
  - The unsigned 64-bit UNIX timestamp corresponding to the last time the account's sequence number was touched.
- subentry_count
  - number
