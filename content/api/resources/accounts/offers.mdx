...
try:
    print(server.offers().for_seller("GD3CJYUTZAY6JQF4CEI6Z7VW5O6VNGKZTBYUECTOJPEDTB7I2HZSPI2K").call())
...
for tx in server.offers().for_seller("GD3CJYUTZAY6JQF4CEI6Z7VW5O6VNGKZTBYUECTOJPEDTB7I2HZSPI2K").cursor("now").stream():
  callback(tx)
```
