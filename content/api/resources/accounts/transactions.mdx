...
try:
    print(server.transactions().for_account("GAYOLLLUIZE4DZMBB2ZBKGBUBZLIOYU6XFLW37GBP2VZD3ABNXCW4BVA").call())
...
for tx in server.transactions().for_account("GAYOLLLUIZE4DZMBB2ZBKGBUBZLIOYU6XFLW37GBP2VZD3ABNXCW4BVA").cursor("now").stream():
  callback(tx)
```
