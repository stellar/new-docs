...
try:
    print(server.effects().for_account("GCNL55IJTH2HX26HLNIGYD2JIQLTBAQL3SVPNZA6PXK7NAVHU423WOTE").call())
...
for tx in server.effects().for_account("GCNL55IJTH2HX26HLNIGYD2JIQLTBAQL3SVPNZA6PXK7NAVHU423WOTE").cursor("now").stream():
  callback(tx)
```
</CodeExample>
