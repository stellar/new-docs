...
try:
    print(server.trades().for_account("GD3CJYUTZAY6JQF4CEI6Z7VW5O6VNGKZTBYUECTOJPEDTB7I2HZSPI2K").call())
...
for tx in server.trades().for_account("GD3CJYUTZAY6JQF4CEI6Z7VW5O6VNGKZTBYUECTOJPEDTB7I2HZSPI2K").cursor("now").stream():
  callback(tx)
```
