...
[posting](../resources/transactions/post-transaction.mdx) and
[getting](../resources/transactions/retrieve-transaction.mdx) transactions and
in the [ledger](../resources/ledgers/retrieve-ledger.mdx) header.
