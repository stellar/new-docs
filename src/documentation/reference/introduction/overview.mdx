...
[stellar-core](../../glossary/stellar-core.mdx). Projects like wallets,
...
[Stellar SDKs](../../software-and-sdks/overview.mdx). To reduce the complexity
of your project, we recommend you use an SDK instead of making direct API calls.
...
- [https://horizon-testnet.stellar.org/](https://horizon-testnet.stellar.org/)
  for interacting with the [testnet](../../glossary/testnet.mdx)
