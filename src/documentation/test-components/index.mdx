...
This is the test components page. Created to see how our react components
render.

<Alert
  content="In addition to markdown, we're planning to incorporate some MDX components."
  color="#2670e6"
/>
...
<Alert
  content="Note: each trustline increases an account’s minimum balance by 0.5 lumens (the base reserve). For more details, see the [fees guide](concepts/fees.md#minimum-balance)."
  color="#2670e6"
/>
